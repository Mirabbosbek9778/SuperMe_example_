  ...
  <table class="w-full text-sm text-left">
    <thead class="text-xs bg-gray-50">
      <tr>
        ...
        <th scope="col" class="py-3 px-6">Ru</th>
        <th scope="col" class="py-3 px-6">En</th>
        <th scope="col" class="py-3 px-6">Fr</th>
        <th scope="col" class="py-3 ">De</th>
      </tr>
    </thead>
    <tbody>
      <tr
      ...
      >
        ...
        <th class="py-4 ">{{ item.rustate }}</th>
        <th class="py-4 ">{{ item.enstate }}</th>
        <th class="py-4 ">{{ item.frstate }}</th>
        <th class="py-4 ">{{ item.frstate }}</th>
        <th class="py-4 ">{{ item.destate }}</th>
      </tr>
    </tbody>
  </table>
